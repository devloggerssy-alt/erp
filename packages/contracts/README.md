...
Database package containing Prisma schema and generated client for the d-clinic application.
...
```env
DATABASE_URL="postgresql://username:password@localhost:5432/d-clinic"
```
