...
export async function seedDocumentSequences(prisma: PrismaClient, tenantId: string): Promise<void> {
    await prisma.documentSequence.createMany({
        ...
        data: [
            ...
            { id: SEED_IDS.DOC_SEQ_PAYMENT_ADJUSTMENT, tenantId, documentType: 'PAYMENT_ADJUSTMENT', prefix: 'ADJ', padding: 5 },
            ...
            { id: SEED_IDS.DOC_SEQ_OPENING,  tenantId, documentType: 'OPENING_BALANCE',  prefix: 'OB',  padding: 5 },
        ],
    })
}
