  ...
  "group/alert relative grid w-full gap-0.5 rounded-lg border px-4 py-3 text-start text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pe-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        info:
          "bg-info-subtle border-info/25 text-info *:data-[slot=alert-description]:text-info/90 *:[svg]:text-current",
        success:
          "bg-success-subtle border-success/25 text-success *:data-[slot=alert-description]:text-success/90 *:[svg]:text-current",
        warning:
          "bg-warning-subtle border-warning/25 text-warning *:data-[slot=alert-description]:text-warning/90 *:[svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
