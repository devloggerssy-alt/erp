...
import { Search, Plus, Minus, Trash2, CheckCircle2, Tag, Receipt } from "lucide-react"
...
const initialProducts: Product[] = [
  {
    ...
    name: "بواجي ليزر NGK",
    oem: "90919-01191",
    compatibility: "تويوتا كامري 15-20",
    price: 150000,
    stock: 40,
    category: "كهرباء",
  },
  ...
  {
    id: 6,
    name: "مساعدات خلفية يمين",
    oem: "55311-2S000",
    compatibility: "هيونداي توسان",
    price: 450000,
    stock: 4,
    category: "ميكانيك",
  },
              ...
              {cart.length === 0 ? (
                ...
                cart.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex flex-col gap-3 p-3 bg-background border border-border rounded-lg shadow-sm"
                    >
                      ...
                      <div className="flex justify-between items-center gap-4">
                        <div className="flex items-center gap-3 bg-muted rounded-md p-1 border">
                          <button
                            ...
                            className="bg-background hover:bg-card text-foreground rounded p-1 shadow-sm"
                          >
                        ...
                        <div className="flex items-center relative w-24">
                          <Tag className="w-3 h-3 text-muted-foreground absolute inset-s-2" />
                          <input
                            type="number"
                            min="0"
                            value={item.discount || ""}
                            onChange={(event) =>
                              updateItemDiscount(item.id, Number(event.target.value))
                            }
                            placeholder="خصم..."
