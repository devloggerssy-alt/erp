...
description: "Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes | ERP trigger: Load when investigating a bug — root-cause first, fix second."
...
# systematic-debugging — ERP Wrapper
